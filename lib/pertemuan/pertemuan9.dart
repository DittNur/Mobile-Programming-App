...
class _DateTimePickerFormState extends State<DateTimePickerForm> {
    ...
    return Theme(
      data: Theme.of(context).copyWith(
        colorScheme: const ColorScheme.light(
          primary: Color(0xFF6F6C63FF),
          onPrimary: Colors.white,
          surface: Colors.white,
          onSurface: Color(0xFF01A1A2E),
        ),
    ...
    if (_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: const Color(0xFF6F6C63FF),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFFF5F4FF),
      appBar: AppBar(
            ...
            children: [
              ...
              OutlinedButton.icon(
                ...
                style: OutlinedButton.styleFrom(
                  foregroundColor: const Color(0xFF6F6C63FF),
                  side: const BorderSide(color: Color(0xFF6F6C63FF)),
  ...
  InputDecoration _deco({
    ...
    return InputDecoration(
      labelText: label,
      hintText: hint,
      prefixIcon: Icon(icon, color: const Color(0xFF6F6C63FF), size: 20),
      suffixIcon: suffix,
      filled: true,
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: Color(0xFF6F6C63FF), width: 1.5),
      ),
  ...
  Widget _buildPreviewCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF6F6C63FF).withOpacity(0.08),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: const Color(0xFF6F6C63FF).withOpacity(0.2),
          width: 1,
        ),
      ),
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.preview_rounded, color: Color(0xFF6F6C63FF), size: 18),
              SizedBox(width: 6),
              Text(
                'Preview Data',
                style: TextStyle(
  ...
  Widget _previewRow(IconData icon, String label, String value) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, size: 15, color: const Color(0xFF6F6C63FF)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF6F6C63FF).withOpacity(0.06),
            blurRadius: 16,
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF6F6C63FF).withOpacity(0.1),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Icon(icon, color: const Color(0xFF6F6C63FF), size: 18),
              ),
